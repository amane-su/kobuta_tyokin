 ...
 */
class OpenGLFragmentGarden : Fragment() {
...
class GLRendererGarden(val context: Context) : GLSurfaceView.Renderer {
...
class ModelGarden(context: Context, objFileName: String) {
